# OV7670 Camera UVC Driver on RP2350

> [!WARNING]
> This documentation was generated by an AI language model (Claude Opus 4.6) based on the provided codebase. It may contain inaccuracies or omissions. Please verify all technical details against the source code and hardware specifications before relying on this information for development or troubleshooting.
...
1. **OV7670 camera module** — A small image sensor that captures video at 160×120 pixels in YUV color format. It outputs pixel data through 8 parallel data lines, synchronized by clock and framing signals.

2. **RP2350 microcontroller (on the "Proton" board)** — A dual-core processor that reads pixel data from the camera, stores it in memory, and sends it to the computer over USB. Its second core is dedicated to running the fruit classifier model.
